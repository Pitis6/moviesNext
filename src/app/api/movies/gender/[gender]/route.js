...
export function GET( reuest, { params }) {
 const movies = [
   {
     id: 1,
     ...
     category: "marvel",
     gender: ["ciencia-ficcion", "comedia", "superheroes", "accion-y-aventura"],
     clasification: "13+",
     releaseYear: "2017",
     frontImage:
  ...
  const movieSelected = movies.filter((movie) => movie.gender.includes(params.gender))
